    ...
    <div class="product product--list">
        <div class="row">
            <div class="col-sm-7 col-md-8 separate-block">
                <a class="product__title" href="">{{ $internet->nome }}</a>
                <div class="product-rating">
                    <div class="score"></div>
                </div>
                <p class="product__info">{{ $internet->descricao }}</p>
            </div><!-- end col -->
            <div class="col-sm-4 col-md-3">
                <div class="product__action">
                    <p class="product__price">R$ {{ number_format($internet->valorresidencial, 2, ',', '.') }}</p>
