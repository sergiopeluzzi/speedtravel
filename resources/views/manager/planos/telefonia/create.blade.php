...
@section('conteudo')
    <section>
        <div class="container">
            <h2 class="heading heading--start">Planos | Telefonia | Cadastro</h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-wrapper">
                        {!! Form::open(['route' => 'manager.planos.telefonia.store', 'method' => 'post', 'class' => 'contact', 'id' => 'crt-telefonia-frm']) !!}
                        ...
                        <div class="form-group col-md-12" align="left">
                            ...
                            <div class="btn--minimal-container-danger btn-present">
                                <a class="btn btn-danger btn--minimal"
                                   href="{{ route('manager.planos.telefonia.index') }}">Voltar</a>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div><!-- end wrapper -->
