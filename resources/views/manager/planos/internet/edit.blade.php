...
@section('conteudo')
    <section>
        <div class="container">
            <h2 class="heading heading--start">Planos | Internet | Edição ({{ $internet->nome }})</h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-wrapper">
                        {!! Form::model($internet, ['route' => ['manager.planos.internet.update', $internet->id], 'method' => 'put', 'class' => 'contact']) !!}
                        ...
                        <div class="form-group col-md-10" align="left">
                            ...
                            {!! Form::select('cidades[]', $cidades, $internet->cidades->lists('id')->all(), ['id' => 'cidades', 'class' => 'contact__field', 'multiple', 'required']) !!}
                        </div>
                        ...
                        <div class="form-group col-md-12" align="left">
                            ...
                            <div class="btn--minimal-container-danger btn-present">
                                <a class="btn btn-danger btn--minimal" href="{{ route('manager.planos.internet.index') }}">Voltar</a>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div><!-- end wrapper -->
